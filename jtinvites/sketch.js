...
function draw() {
  ...
  if(frameCount > resizeFrameEnd) {
    ...
    text(nameLabel.display, 25, height * whiteSectionHeightStart + 40);
    textFont(DotoFont);
    textSize(28);
    if(frameCount % 2 == 0 && name.display.length < name.target.length) {
      name.display += name.target[name.display.length];
    }
    text(name.display, 25, height * whiteSectionHeightStart + 53);
    ...
    textAlign(RIGHT, TOP);
    text(datesLabel.display, width - 25, height * whiteSectionHeightStart + 95);
    textFont(DotoFont);
    textSize(20);
    if(frameCount % 2 == 0 && dates.display.length < dates.target.length) {
      dates.display += dates.target[dates.display.length];
    }
    text(dates.display, width - 25, height * whiteSectionHeightStart + 108);
    ...
    text(estimatedPriceLabel.display, 25, height * whiteSectionHeightStart + 95);
    textFont(DotoFont);
    textSize(20);
    ...
    text(estimatedPrice.display, 25, height * whiteSectionHeightStart + 108);
    ...
    text(message.display, width/2, height * whiteSectionHeightStart + 150);
    ...
    text(callToAction.display, 10, height * whiteSectionHeightStart + 175, width - 20, height * (1 - whiteSectionHeightStart) - 95);
    ...
    text(admitOne.display, width/2, height - 90);
    textSize(24)
    textFont(DotoFont);
    text(admitOne.displayEnglish, width/2, height - 40);
    pop();
  }
}
